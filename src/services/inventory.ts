...
import { inventoryLots, inventoryMovements, medicines, type InventoryLot } from '../data.js';

function _addDays(startIso: string, days: number) {
...
export function createLotEntry(input: {
  medicineId: string;
  batchCode: string;
  expiresAt: string;
  quantity: number;
