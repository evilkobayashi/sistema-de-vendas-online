...
export default function Cadastros() {
  ...
  return (
    <>
      ...
      <div className="kpis">
        <div className="kpi"><div className="value">{stats.employees}</div><div>Funcionários</div></div>
        <div className="kpi"><div className="value">{stats.suppliers}</div><div>Fornecedores</div></div>
        <div className="kpi"><div className="value">{stats.finishedProducts}</div><div>Produtos acabados</div></div>
        <div className="kpi"><div className="value">{stats.rawMaterials}</div><div>Matérias-primas</div></div>
        <div className="kpi"><div className="value">{stats.standardFormulas}</div><div>Fórmulas padrão</div></div>
        <div className="kpi"><div className="value">{stats.packagingFormulas}</div><div>Fórmulas embalagem</div></div>
      </div>
